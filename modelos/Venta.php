...
Class Venta
{
	...
	public function editar($idventa,$idcliente,$idusuario,$tipo_comprobante,$serie_comprobante,$num_comprobante,$fecha_hora,$impuesto,$total_venta,$idarticulo,$cantidad,$precio_venta,$descuento)
	{
		$sql="UPDATE venta SET idcliente='$idcliente',idusuario='$idusuario',tipo_comprobante='$tipo_comprobante',serie_comprobante='$serie_comprobante',num_comprobante='$num_comprobante',fecha_hora='$fecha_hora',impuesto='$impuesto',total_venta='$total_venta' WHERE idventa='$idventa'";
	...
	//Implementamos un método para confirmar el pago de la venta
	public function pagar($idventa)
	{
		$sql="UPDATE venta SET estado='Pagado' WHERE idventa='$idventa'";
		return ejecutarConsulta($sql);
	}
