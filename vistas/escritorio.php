                        ...
                        <div class="small-box bg-aqua">
                          <div class="inner">
                            <h4 style="font-size:17px;">
                              <strong><?php echo $totalc; ?> ventas realizadas</strong>
                            </h4>
                          ...
                          <a href="ventasfechacliente.php" class="small-box-footer">Consulta Ventas <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                          <div class="box box-primary">
                              <div class="box-header with-border">
                                Cantidad de Ventas de los últimos 12 meses
                              </div>
                              <div class="box-body">
...
var compras = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Cantidad de Ventas en los últimos 12 meses',
