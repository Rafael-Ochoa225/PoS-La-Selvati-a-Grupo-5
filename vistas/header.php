...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../public/img/logo-icon.png">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><i class="fa fa-star"></i><b> LA SELVATINA </b><i class="fa fa-star"></i></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <br>
                      Usuario: <?php echo $_SESSION['login']; ?>
        ...
        <section class="sidebar">       
          ...
          <ul class="sidebar-menu">
            ...
            if ($_SESSION['cocina']==1)
            {
              echo '<li class="treeview">
              <a href="#">
                <i class="fa fa-cutlery"></i> <span>Cocina</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="cocina.php"><i class="fa fa-circle-o"></i> Cocina</a></li>                
              </ul>
            </li>';
            }
            ?>
            ...
            if ($_SESSION['ventas']==1)
            {
              echo '<li class="treeview">
              <a href="#">
                <i class="fa fa-coffee"></i> <span>Pedidos</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
            ...
            if ($_SESSION['ventas']==1)
            {
              ...
              <ul class="treeview-menu">
                <li><a href="venta1.php"><i class="fa fa-circle-o"></i> Ventas</a></li>
                <li><a href="cliente.php"><i class="fa fa-circle-o"></i> Clientes</a></li>
              </ul>
            </li>';
            }
